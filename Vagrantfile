...
Vagrant.configure("2") do |config|
  ...
  config.vm.define :consul do |consul|
    ...
    consul.vm.network :private_network, ip: "192.168.100.11"
    consul.vm.hostname = "consul"
    consul.vm.provision "shell", path: "scripts/install_consul.sh"
  ...
  config.vm.define :app1 do |app1|
    ...
    app1.vm.network :private_network, ip: "192.168.100.21"
    app1.vm.hostname = "app1"
    app1.vm.provision "shell", path: "scripts/install_app.sh"
  ...
  config.vm.define :app2 do |app2|
    ...
    app2.vm.network :private_network, ip: "192.168.100.22"
    app2.vm.hostname = "app2"
    app2.vm.provision "shell", path: "scripts/install_app.sh"
  ...
  config.vm.define :app3 do |app3|
    app3.vm.box = "bento/ubuntu-22.04"
    app3.vm.network :private_network, ip: "192.168.100.23"
    app3.vm.hostname = "app3"
    app3.vm.provision "shell", path: "scripts/install_app.sh"
